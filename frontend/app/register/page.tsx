  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium">Password (6+ chars)</label>
          <input
            type="password"
            value={password}
      ...
      <p className="mt-4 text-center text-sm text-gray-600">
        Already have account? <Link href="/login" className="text-indigo-600 hover:underline">Login</Link>
      </p>
    </div>
  );
}
